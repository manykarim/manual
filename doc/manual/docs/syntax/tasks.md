...
the [test case section](../appendices/available-settings.md#test-case-section). In the [setting section](resource-and-variable-files.md#setting-section) it is possible to use
